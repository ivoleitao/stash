...
typedef TestContextBuilder<T extends Store<CacheStat, CacheEntry>>
    = TestContext<T> Function(ValueGenerator generator);

/// Store builder function
typedef StoreBuilder<T extends Store<CacheStat, CacheEntry>> = Future<T>
    Function();
...
void check<T extends Store<CacheStat, CacheEntry>>(
...
Cache newDefaultCache<T extends Store<CacheStat, CacheEntry>>(T store,
    {String? name,
    ExpiryPolicy? expiryPolicy,
    KeySampler? sampler,
    EvictionPolicy? evictionPolicy,
...
abstract class TestContext<T extends Store<CacheStat, CacheEntry>> {
  /// A value generator
