...
abstract class SharedPreferencesStore<I extends Info, E extends Entry<I>>
    extends PersistenceStore<I, E> {
  /// The adapter
  final SharedPreferencesAdapter _adapter;

  /// Builds a [SharedPreferencesStore].
  ///
  ...
  SharedPreferencesStore(this._adapter, {super.codec});
...
class SharedPreferencesVaultStore
    extends SharedPreferencesStore<VaultInfo, VaultEntry>
...
class SharedPreferencesCacheStore
    extends SharedPreferencesStore<CacheInfo, CacheEntry>
