...
void main() async {
  ...
  test('Boolean', () async {
    await testStoreWith<SqliteStore>(DefaultContext(BoolGenerator()));
    await testCacheWith<SqliteStore>(DefaultContext(BoolGenerator()));
  });

  test('Int', () async {
    await testStoreWith<SqliteStore>(DefaultContext(IntGenerator()));
    await testCacheWith<SqliteStore>(DefaultContext(IntGenerator()));
  });

  test('Double', () async {
    await testStoreWith<SqliteStore>(DefaultContext(DoubleGenerator()));
    await testCacheWith<SqliteStore>(DefaultContext(DoubleGenerator()));
  });

  test('String', () async {
    await testStoreWith<SqliteStore>(DefaultContext(StringGenerator()));
    await testCacheWith<SqliteStore>(DefaultContext(StringGenerator()));
  });

  test('List<bool>', () async {
    await testStoreWith<SqliteStore>(
        DefaultContext(IteratorGenerator(BoolGenerator())));
    await testCacheWith<SqliteStore>(
        DefaultContext(IteratorGenerator(BoolGenerator())));
  });
  ...
  test('Class<List<bool>>', () async {
    await testStoreWith<SqliteStore>(ObjectContext(
        SampleClassGenerator(IteratorGenerator(BoolGenerator()))));
    await testCacheWith<SqliteStore>(ObjectContext(
        SampleClassGenerator(IteratorGenerator(BoolGenerator()))));
  });
  ...
  test('Class<Map<bool,double>>', () async {
    await testStoreWith<SqliteStore>(ObjectContext(SampleClassGenerator(
        MapGenerator(BoolGenerator(), DoubleGenerator()))));
    await testCacheWith<SqliteStore>(ObjectContext(SampleClassGenerator(
        MapGenerator(BoolGenerator(), DoubleGenerator()))));
  });
